...
##IMPORTANT: if using token features, you can also tweak the per-feature-template embedding sizes below (eg, tokenString:50)
...
if [ "$initEmbeddings" != "$initModel" ]; then
...
options="$options -saveFrequency 5 -model $modelBase"
